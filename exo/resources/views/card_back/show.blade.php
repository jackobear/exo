    ...
    <div class="row" style="background-color: #000">
      <div class="large-12 columns">
        <div class="card" style="width: 678px;height:980px;margin:73px 0px 72px 59px;border-radius:15px;">
            ...
            <canvas id="myCanvas" width="700" height="980?>" style="background-image: url('/img/art/card-backs/<?php
              echo strtolower(str_replace(" ", "-", $card_type));
            ?>.png');background-size: cover;background-repeat: no-repeat;background-position: 50% 50%;"></canvas>
