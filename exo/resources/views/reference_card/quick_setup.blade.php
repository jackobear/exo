        ...
        <div class="glow" id="body" style="width: 1579px;height:985px;margin:70px 0px 70px 59px;border-radius:15px;">
          ...
          <ol id='quick-setup' style="">
            ...
            <li>
              ...
              on each <img src='/img/art/symbols/eternal-light.png' style='height:50px;' />Peak of Eternal Light in the habitable zone or closer to the ST Star.
            </li>
            <li>Each player draws a random Faction card and that Faction's starting cards.</li>
            <li>Each player gets one FO Food, one ME Metal and one WA Water.</li>
            <li>Each player gets FU Fuel equal to the
